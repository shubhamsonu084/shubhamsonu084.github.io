    ...
    <section className="section section-alt" id="projects">
      <div className="container">
        ...
        <p className="section-subtitle reveal reveal-delay-2" style={{ marginBottom: '3rem' }}>
          A selection of things I've built — spanning AI products, fintech, and strategic analysis.
        </p>

        <div className="projects-grid">
          {projects.map((project, i) => (
            <div key={project.id} className={`glass-card project-card reveal reveal-delay-${Math.min(i + 1, 5)}`}>
